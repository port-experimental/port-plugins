 ...
 *
 * Like SPACE, this object is the source of truth shipped in the build, and the
 * same shape can live on a `survey` entity's `definition` property - when
 * present there it overrides this template so questions/scales change with no
 * rebuild.
 */
