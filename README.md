...
| [Github Copilot AI Adoption and Usage](./engineering-intelligence-ai-usage-copilot) | 0.1.0 | Custom Port plugin that turns raw GitHub Copilot organization metrics into an interactive engineering intelligence dashboard. Tracks active users, acceptance rates, lines of code, PR activity, and (optionally) generates AI insight reports about your Copilot usage. |
