...
| [Copilot AI Adoption & Usage](./engineering-intelligence-ai-usage-copilot) | 0.1.0 | Custom Port plugin that turns raw GitHub Copilot organization metrics into an interactive engineering intelligence dashboard |
