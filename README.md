...
| [Entity Comment Thread](./entity-comment-thread) | 0.1.0 | Collaborative comment thread on entity pages with rich text, @mentions, replies, and open/resolved threads |
